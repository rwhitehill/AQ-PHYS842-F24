...
Observe that 
\begin{align}
    \mathcal{L}^{*} &= \psi^{\dagger} ( -i \overleftarrow{\partial}_{0} - i \gamma^{0} \gamma^{0} \gamma^{i} \gamma^{0} \overleftarrow{\partial}_{i} - m \gamma^{0} ) \psi \nonumber \\
                    &= \bar{\psi} ( -i \gamma^{0} \overleftarrow{\partial}_{0} + i \gamma^{i} \overleftarrow{\partial}_{i} - m ) \psi \nonumber \\
                    &= \bar{\psi} (- i \gamma^{\mu} \overleftarrow{\partial}^{\mu} - m) \psi + 2 i \gamma^{i} \overleftarrow{\partial}_{i}
.\end{align}
Thus
\begin{align}
    \mathcal{L}_{\rm sym} = \frac{i}{2} \bar{\psi} ( \gamma^{\mu} \overleftrightarrow{\partial}_{\mu} - m ) \psi 
.\end{align}
